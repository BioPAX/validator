...
public class MiriamLink {
   ...
   */
  public static final String XML_LOCATION = "https://www.ebi.ac.uk/miriam/main/export/xml/";
...
//SCHEMA_LOCATION: "https://www.ebi.ac.uk/compneur-srv/miriam/static/main/xml/MiriamXML.xsd";
  ...
  static {
    try {
      ...
      log.info("MIRIAM XML imported, version: "
        + miriam.getDataVersion() + ", datatypes: " + miriam.getDatatype().size());
  ...
  public static String getServicesVersion() {
    return miriam.getDate() + "; " + miriam.getDataVersion();
  }
