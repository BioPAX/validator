 ...
 * @author rodche
 *
 * @param <T> a type the rule can validate, though it also depends
 *           on {@link #canCheck(Object)} method implementation
 */
public abstract class BaseRule<T> implements Rule<T> {
  ...
  public void error(final Validation validation, Object object, String code, boolean setFixed, Object... args) {
    ...
    ErrorType error = (utils != null)
      ...
      : ValidatorUtils.error(thingId, code, getClass().getName(), setFixed, args);
