...
copy the lib/spring-instrument-tomcat-${spring.version}.jar, which enables 
...
adding "-javaagent:/path/to/spring-instrument-${spring.version}.jar" 
...
(See also: http://static.springsource.org/spring/docs/${spring.version}/spring-framework-reference/html/aop.html#aop-aj-ltw-environments).
...
I. Framework
 ...
 1. Uses Paxtools Java library (the BioPAX API), version ${paxtools.version}.
 2. Spring Framework ${spring.version} - to report errors (AOP), wire different modules,
