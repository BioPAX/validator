...
VALIDATOR_OPTS="-javaagent:lib/spring-instrument-${agent.version}.jar -Xmx4g -Dfile.encoding=UTF-8 -Dpaxtools.CollectionProvider=org.biopax.paxtools.trove.TProvider"
...
$JAVA_HOME/bin/java --illegal-access=permit -server $VALIDATOR_OPTS -jar biopax-validator-web.war -httpPort=8080
