set VALIDATOR_OPTS="-javaagent:lib/spring-instrument-${spring.version}.jar -Xms2g -Xmx2g -Dfile.encoding=UTF-8 -Djava.io.tmpdir=tmp -Dnet.sf.ehcache.skipUpdateCheck=true"
