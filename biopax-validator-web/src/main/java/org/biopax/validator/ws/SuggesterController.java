...
public class SuggesterController implements Suggester {

  private Suggester service;
  private XrefHelper xrefHelper;


  //TODO: remove xrefHelper - use via Suggester
  @Autowired
  public SuggesterController(Suggester suggester,XrefHelper xrefHelper) {
    this.service = suggester;
